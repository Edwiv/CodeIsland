...
final class L10n: ObservableObject {
    ...
    private static let en: [String: String] = [
        ...
        "hover_expand_delay": "Hover Expand Delay",
        "hover_expand_delay_desc": "Delay before the island expands on hover (anti-mistouch). Lower = more responsive.",
        "show_mascot": "Show Pixel Mascot",
        "show_mascot_desc": "When off, show what the active agent is doing right now (Bash / Read / Thinking …) instead of the animated mascot.",
        "glow_ring": "Glow Ring",
        "glow_ring_desc": "Show a soft glow around the island: blue while working, orange when awaiting you, green flash on completion.",
        "glow_when_collapsed": "Glow When Collapsed",
        "glow_when_collapsed_desc": "Also show the glow while the island is collapsed. Turn off to glow only when the panel is expanded.",
        "glow_intensity": "Glow Intensity",
        "glow_intensity_desc": "How bright the glow ring is. 100% is the baseline; raise it to make the working / waiting / done glow more obvious.",
        "glow_running_intensity": "Running Glow Intensity",
        "glow_running_intensity_desc": "Brightness of the blue “working” glow specifically. 0% hides it (so only waiting / done glow shows); separate from the overall intensity above.",
        "completion_display": "Completion Display Time",
        "completion_display_desc": "How long the green “done” card stays expanded after a task finishes before the island collapses.",
        "reserve_menu_bar_width": "Reserve Menu Bar Width",
        "reserve_menu_bar_width_desc": "Occupy real menu-bar width so neighboring status icons move aside instead of being half-covered.",
        "shortcuts": "Shortcuts",
        ...
        "session_detail_fields": "Session Detail Chips",
        "chip_elapsed": "Elapsed Runtime",
        "chip_model": "Model Name",
        "chip_tool_count": "Tool Call Count",
        "chip_cwd": "Working Folder",
        "chip_permission_mode": "Permission Mode",
        "chip_context_window": "Context Window Usage",
        "chip_tokens": "Token Usage (in / out)",
        ...
        "remote_auto_resume": "Auto-resume (reconnect on drop)",
        "ssh_config_hosts": "SSH Config Hosts",
        "ssh_config_hosts_desc": "Hosts read from ~/.ssh/config. Toggle auto-connect / auto-resume per host.",
        "ssh_config_refresh": "Refresh",
        "ssh_config_empty": "No hosts found in ~/.ssh/config",
        "remote_editor": "Remote Editor",
        "remote_editor_desc": "Editor used to open remote (SSH) sessions via Remote-SSH.",
        ...
        // Lark (Feishu) bot push
        "lark": "Lark",
        "lark_enable": "Enable Lark Push",
        "lark_enable_desc": "When a confirmation goes unanswered on this Mac for the delay below, push it to your phone via your own Lark bot so you can approve / deny / answer there. Replies sync both ways.",
        "lark_app_id": "App ID",
        "lark_app_secret": "App Secret",
        "lark_target": "Push Target",
        "lark_target_dm": "Direct message",
        "lark_target_group": "Group chat",
        "lark_target_value_dm": "Email or user_id",
        "lark_target_value_group": "Group chat_id",
        "lark_push_delay": "Push Delay (seconds)",
        "lark_push_delay_desc": "How long the desktop waits before pushing to your phone (0 = immediately). Remote SSH sessions are capped at 240s.",
        "lark_include_questions": "Also push questions",
        "lark_include_questions_desc": "Push AskUserQuestion prompts too, not just permission approvals.",
        "lark_status": "Status",
        "lark_status_disabled": "Disabled",
        "lark_status_starting": "Connecting…",
        "lark_status_ready": "Connected: %@",
        "lark_status_missing_dep": "Python package missing — run: pip3 install lark-oapi",
        "lark_status_error": "Error: %@",
        "lark_test": "Send Test Card",
        "lark_test_sent": "Test card sent ✅",
        "lark_urgent_failed": "Urgent push failed",
        "lark_setup_hint": "Setup: create a self-built app on the Lark/Feishu open platform → enable Bot → set event subscription to long-connection (WebSocket) and subscribe card.action.trigger → grant message send and app-urgent message permissions. Email DM urgent also needs contact ID lookup; group urgent also needs chat member lookup. Fill App ID / Secret here; for a DM enter your email, for a group enter its chat_id. Requires: pip3 install lark-oapi.",
        "lark_card_approval_title": "⚠️ Agent needs permission",
        "lark_card_question_title": "🤖 Agent has a question",
        "lark_card_test_title": "✅ CodeIsland test",
        "lark_btn_allow_once": "Allow once",
        "lark_btn_allow_always": "Always allow",
        "lark_btn_deny": "Deny",
        "lark_btn_submit": "Submit",
        "lark_btn_skip": "Skip",
        "lark_card_footer": "📍 from CodeIsland · desktop confirmation timed out",
        "lark_card_resolved_desktop": "✅ Handled on the computer",
        "lark_card_resolved_phone": "✅ Confirmed on your phone",
        "lark_card_test_body": "If you can see this card, your Lark push is configured correctly.",
        "lark_card_agent": "Agent",
        "lark_card_project": "Project",
        "lark_card_permission": "Permission",
        "lark_card_please_select": "Please select",
        "lark_card_answer_on_desktop": "This question has no preset options — please answer on your computer.",
        ...
        "apple_companion_channel_lan": "Wi-Fi / LAN (interactive)",
        "apple_companion_channel_ble": "Bluetooth (view only)",
        "apple_companion_channel_hint": "Approving / answering needs the LAN channel (same Wi-Fi, or Wi-Fi radio on for AWDL). Bluetooth only mirrors status for viewing — it can't send actions back.",
        "apple_companion_ble_subscribed": "Phone subscribed",
        "apple_companion_ble_advertising": "Advertising…",
        "apple_companion_ble_off": "Bluetooth off / not authorized",
        ...
        "dashboard_title": "All Agents",
        "dashboard_group_machine": "Machine",
        "dashboard_group_cli": "Agent",
        "dashboard_group_status": "Status",
        "dashboard_group_project": "Project",
        "dashboard_machines": "Machines",
        "dashboard_agents": "Agents",
        "dashboard_empty": "No active sessions",
        "dashboard_select": "Select a session to see details",
        "dashboard_jump": "Jump",
        "dashboard_machine": "Machine",
        "dashboard_path": "Path",
        "dashboard_model": "Model",
        "dashboard_status": "Status",
        "dashboard_terminal": "Terminal",
        "dashboard_last_prompt": "Last Prompt",
        "dashboard_last_reply": "Last Reply",
        "dashboard_recent_tools": "Recent Tools",
        "dashboard_live": "live",
        "dashboard_needs_you": "NEED YOU",
        "dashboard_fleet": "FLEET",
        "dashboard_run": "RUN",
        "dashboard_wait": "WAIT",
        "dashboard_idle": "IDLE",
        "dashboard_err": "ERR",
        "dashboard_all_quiet": "ALL QUIET",
        ...
        "dashboard_remote": "remote",
        "dashboard_ssh_ok": "ssh ok",
        "dashboard_ssh_connecting": "connecting",
        "dashboard_ssh_failed": "ssh failed",
        "dashboard_idle_label": "idle",
        "dashboard_load": "load",
        "dashboard_count": "n",
        "other": "Other",
        "n_sessions": "sessions",
    ...
    private static let zh: [String: String] = [
        ...
        "haptic_medium": "中",
        "haptic_strong": "强",
        "hover_expand_delay": "悬浮展开延迟",
        "hover_expand_delay_desc": "鼠标悬浮到灵动岛后展开的延迟（防误触）。越小越灵敏。",
        "show_mascot": "显示像素头像",
        "show_mascot_desc": "关闭后，改为实时显示当前 Agent 正在执行的动作（Bash / Read / 思考中 …），而非动画头像。",
        "glow_ring": "辉光圈",
        "glow_ring_desc": "在灵动岛周围显示柔和辉光：运行中为蓝色，待确认时为橙色，任务完成时绿色闪烁。",
        "glow_when_collapsed": "收起时显示辉光",
        "glow_when_collapsed_desc": "灵动岛收起（未展开）时也显示辉光。关闭后仅在面板展开时显示辉光。",
        "glow_intensity": "辉光强度",
        "glow_intensity_desc": "辉光圈的亮度。100% 为基准值；调高可让运行中 / 待确认 / 完成时的辉光更明显。",
        "glow_running_intensity": "运行中辉光强度",
        "glow_running_intensity_desc": "单独控制蓝色「运行中」辉光的亮度。0% 则隐藏（只显示待确认 / 完成的辉光）；与上面的总体强度相互独立。",
        "completion_display": "完成展示时长",
        "completion_display_desc": "任务完成后，绿色「完成」卡片在灵动岛收起前保持展开的时间。",
        "reserve_menu_bar_width": "占用状态栏宽度",
        "reserve_menu_bar_width_desc": "真实占用一段菜单栏宽度，让相邻状态栏图标主动让位，而不是被遮住一半。",
        "shortcuts": "快捷键",
        ...
        "session_detail_fields": "会话详情标签",
        "chip_elapsed": "运行时间",
        "chip_model": "模型名称",
        "chip_tool_count": "工具调用次数",
        "chip_cwd": "工作目录",
        "chip_permission_mode": "权限模式",
        "chip_context_window": "上下文窗口用量",
        "chip_tokens": "Token 用量（输入 / 输出）",
        ...
        "remote_auto_resume": "自动恢复（断线自动重连）",
        "ssh_config_hosts": "SSH 配置主机",
        "ssh_config_hosts_desc": "从 ~/.ssh/config 读取的主机。可逐个开启自动连接 / 自动恢复。",
        "ssh_config_refresh": "刷新",
        "ssh_config_empty": "在 ~/.ssh/config 中未找到主机",
        "remote_editor": "远程编辑器",
        "remote_editor_desc": "通过 Remote-SSH 打开远程（SSH）会话时使用的编辑器。",
        ...
        "lark": "飞书",
        "lark_enable": "启用飞书推送",
        "lark_enable_desc": "当某个确认在电脑上超过下方设定的时长仍未处理时，通过你自建的飞书机器人推送到手机，可在手机上允许/拒绝/回答。两端状态双向同步。",
        "lark_app_id": "App ID",
        "lark_app_secret": "App Secret",
        "lark_target": "推送目标",
        "lark_target_dm": "私聊",
        "lark_target_group": "群聊",
        "lark_target_value_dm": "邮箱或 user_id",
        "lark_target_value_group": "群 chat_id",
        "lark_push_delay": "推送延迟（秒）",
        "lark_push_delay_desc": "电脑端等待多久未确认后推送到手机（0 = 立即）。远程 SSH 会话最长 240 秒。",
        "lark_include_questions": "同时推送提问",
        "lark_include_questions_desc": "除权限审批外，也推送 AskUserQuestion 提问。",
        "lark_status": "状态",
        "lark_status_disabled": "未启用",
        "lark_status_starting": "连接中…",
        "lark_status_ready": "已连接：%@",
        "lark_status_missing_dep": "缺少 Python 依赖 — 请运行：pip3 install lark-oapi",
        "lark_status_error": "错误：%@",
        "lark_test": "发送测试卡片",
        "lark_test_sent": "测试卡片已发送 ✅",
        "lark_urgent_failed": "加急推送失败",
        "lark_setup_hint": "配置：在飞书开放平台创建自建应用 → 开启机器人能力 → 事件订阅切换为「长连接」(WebSocket) 并订阅 card.action.trigger → 申请消息发送和应用内加急消息权限。邮箱私聊加急还需要用户 ID 查询权限，群聊加急还需要群成员查询权限。在此填写 App ID / Secret；私聊填你的邮箱，群聊填 chat_id。需先 pip3 install lark-oapi。",
        "lark_card_approval_title": "⚠️ Agent 请求权限确认",
        "lark_card_question_title": "🤖 Agent 有问题待回复",
        "lark_card_test_title": "✅ CodeIsland 测试卡片",
        "lark_btn_allow_once": "允许本次",
        "lark_btn_allow_always": "始终允许",
        "lark_btn_deny": "拒绝",
        "lark_btn_submit": "提交",
        "lark_btn_skip": "跳过",
        "lark_card_footer": "📍 来自 CodeIsland · 电脑超时未确认代答",
        "lark_card_resolved_desktop": "✅ 已在电脑处理",
        "lark_card_resolved_phone": "✅ 已在手机确认",
        "lark_card_test_body": "如果你看到这张卡片，说明飞书推送已配置成功。",
        "lark_card_agent": "Agent",
        "lark_card_project": "项目",
        "lark_card_permission": "权限请求",
        "lark_card_please_select": "请选择",
        "lark_card_answer_on_desktop": "该问题没有预设选项 — 请在电脑上回答。",
        ...
        "apple_companion_channel_lan": "局域网 Wi-Fi（可交互）",
        "apple_companion_channel_ble": "蓝牙（仅查看）",
        "apple_companion_channel_hint": "同意 / 回答等交互必须走局域网通道（同一 Wi-Fi，或开着 Wi-Fi 射频走 AWDL 直连）。蓝牙只能镜像状态用于查看，无法把操作传回。",
        "apple_companion_ble_subscribed": "手机已订阅",
        "apple_companion_ble_advertising": "广播中…",
        "apple_companion_ble_off": "蓝牙未开启或未授权",
        ...
        "dashboard_title": "全部 Agent",
        "dashboard_group_machine": "机器",
        "dashboard_group_cli": "Agent",
        "dashboard_group_status": "状态",
        "dashboard_group_project": "项目",
        "dashboard_machines": "机器",
        "dashboard_agents": "Agent",
        "dashboard_empty": "暂无活跃会话",
        "dashboard_select": "选择一个会话查看详情",
        "dashboard_jump": "跳转",
        "dashboard_machine": "机器",
        "dashboard_path": "路径",
        "dashboard_model": "模型",
        "dashboard_status": "状态",
        "dashboard_terminal": "终端",
        "dashboard_last_prompt": "最近提问",
        "dashboard_last_reply": "最近回复",
        "dashboard_recent_tools": "最近工具",
        "dashboard_live": "活跃",
        "dashboard_needs_you": "需要处理",
        "dashboard_fleet": "机群",
        "dashboard_run": "运行",
        "dashboard_wait": "等待",
        "dashboard_idle": "空闲",
        "dashboard_err": "中断",
        "dashboard_all_quiet": "一切平静",
        "dashboard_approve": "待批准",
        "dashboard_ask": "待回答",
        "dashboard_stopped": "已中断",
        "dashboard_tools": "工具",
        "dashboard_subs": "子代理",
        "dashboard_sessions": "会话",
        "dashboard_local": "本机",
        "dashboard_remote": "远程",
        "dashboard_ssh_ok": "已连接",
        "dashboard_ssh_connecting": "连接中",
        "dashboard_ssh_failed": "连接失败",
        "dashboard_idle_label": "空闲",
        "dashboard_load": "负载",
        "dashboard_count": "数",
        "other": "其他",
        "n_sessions": "个会话",
    ...
    private static let ja: [String: String] = en.merging([
        // Settings pages
        "general": "一般",
        "behavior": "動作",
        "appearance": "外観",
        ...
        "session_detail_fields": "セッション詳細チップ",
        "chip_elapsed": "経過時間",
        "chip_model": "モデル名",
        "chip_tool_count": "ツール呼び出し回数",
        "chip_cwd": "作業フォルダ",
        "chip_permission_mode": "権限モード",
        "chip_context_window": "コンテキストウィンドウ使用量",
        "chip_tokens": "トークン使用量（入力 / 出力）",
    ...
    private static let ko: [String: String] = en.merging([
        // Settings pages
        "general": "일반",
        "behavior": "동작",
        "appearance": "외관",
        ...
        "session_detail_fields": "세션 상세 칩",
        "chip_elapsed": "실행 시간",
        "chip_model": "모델 이름",
        "chip_tool_count": "도구 호출 횟수",
        "chip_cwd": "작업 폴더",
        "chip_permission_mode": "권한 모드",
        "chip_context_window": "컨텍스트 윈도우 사용량",
        "chip_tokens": "토큰 사용량 (입력 / 출력)",
    ...
    private static let tr: [String: String] = en.merging([
        // Settings pages
        "general": "Genel",
        "behavior": "Davranış",
        "appearance": "Görünüm",
        ...
        "session_detail_fields": "Oturum Detay Etiketleri",
        "chip_elapsed": "Geçen Süre",
        "chip_model": "Model Adı",
        "chip_tool_count": "Araç Çağrı Sayısı",
        "chip_cwd": "Çalışma Klasörü",
        "chip_permission_mode": "İzin Modu",
        "chip_context_window": "Bağlam Penceresi Kullanımı",
        "chip_tokens": "Token Kullanımı (giriş / çıkış)",
