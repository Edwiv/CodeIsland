...
final class L10n: ObservableObject {
    ...
    private static let en: [String: String] = [
        ...
        "lark_test_sent": "Test card sent ✅",        "lark_setup_hint": "Setup: create a self-built app on the Lark/Feishu open platform → enable Bot → set event subscription to long-connection (WebSocket) and subscribe card.action.trigger → grant the im:message send permission. Fill App ID / Secret here; for a DM enter your email, for a group enter its chat_id. Requires: pip3 install lark-oapi.",
    ...
    private static let zh: [String: String] = [
        ...
        "lark_setup_hint": "配置：在飞书开放平台创建自建应用 → 开启机器人能力 → 事件订阅切换为「长连接」(WebSocket) 并订阅 card.action.trigger → 申请 im:message 发消息权限。在此填写 App ID / Secret；私聊填你的邮箱，群聊填 chat_id。需先 pip3 install lark-oapi。",
